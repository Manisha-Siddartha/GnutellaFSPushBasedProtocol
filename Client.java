...
public class Client extends TimerTask implements Runnable{
     ...
     */
     ...
     public void run() {
       ...
       String [] temp = combinedValue.split(",");				//splitting values seperated by comma
       String portName = temp[0];								// storing selected portname
     ...
     //file checker    
         ...
         try {
             ...
             path = Si.getDirectory(portName);												// getteing the directory assigned to the selected peer from its server
